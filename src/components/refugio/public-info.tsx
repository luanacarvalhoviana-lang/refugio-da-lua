...
export function PrivacyPage() {
  return <InfoShell eyebrow="seus dados são seus" title="Política de Privacidade" intro="Esta página explica, em linguagem direta, quais dados podem ser usados para o Refúgio funcionar e quais escolhas você tem sobre eles.">
    ...
    <Section title="7. Seus direitos"><p>Você pode solicitar acesso, correção, exclusão, informação sobre o uso e portabilidade dos seus dados, observadas as limitações legais e técnicas. Para exercer esses direitos, use o canal de contato informado no site ou no painel da sua conta.</p></Section>
...
export function TermsPage() {
  return <InfoShell eyebrow="convivência com cuidado" title="Termos de Uso" intro="Estes termos definem as regras básicas para usar o Refúgio com segurança, respeito e expectativas claras.">
    ...
    <Section title="9. Atualizações e contato"><p>Estes termos podem ser atualizados quando o produto ou as exigências legais mudarem. A versão vigente será indicada pela data no topo da página. Em caso de dúvida, procure o canal de contato informado no site.</p></Section>
