...
const lastUpdated = "8 de setembro de 2026";
...
export function AboutPage() {
  return <InfoShell eyebrow="um lugar para pousar" title="Cuidado sem pressa, presença sem julgamento." intro="O Refúgio da Lua é um espaço digital de acolhimento, escrita e autocuidado para quem precisa de um lugar seguro para chegar como está.">
    ...
    <Section title="Nossos limites"><p>O Refúgio é uma plataforma de apoio e bem-estar. Não é serviço médico, psicológico, psiquiátrico, de emergência ou de diagnóstico. Em uma situação de risco imediato, procure o serviço de emergência da sua região. No Brasil, o CVV atende pelo 188.</p><Button asChild className="button button-secondary"><Link to="/apoio">Ver orientações de apoio <ArrowRight size={16} /></Link></Button></Section>
...
export function PrivacyPage() {
  return <InfoShell eyebrow="seus dados são seus" title="Política de Privacidade" intro="Esta página explica, em linguagem direta, quais dados podem ser usados para o Refúgio funcionar e quais escolhas você tem sobre eles.">
    ...
    <Section title="1. Quem somos"><p>O Refúgio da Lua é uma plataforma digital de acolhimento, escrita emocional e autocuidado, operada sob esse nome. Para assuntos de privacidade, escreva para <a href="mailto:contato.refugiodalua@gmail.com">contato.refugiodalua@gmail.com</a>. No perfil público e nas cartas aparece apenas o pseudônimo que você escolher — não o nome civil de ninguém.</p></Section>
    ...
    <Section title="3. Para que usamos os dados"><p>Usamos os dados para autenticar sua conta, salvar suas escolhas, exibir os recursos solicitados, proteger a plataforma contra abuso, responder ao suporte e processar assinaturas quando você escolher um plano VIP.</p><p>Não vendemos seus dados pessoais. Não usamos seus textos para publicidade personalizada.</p></Section>
    <Section title="4. Conteúdo e visibilidade"><p>Você escolhe se uma carta vai ao Mural. Cartas no mural evaporam: sem cuidado, em dois dias; com energia ou conselho, em uma semana. Depois viram húmus no seu jardim ou vão ao diário — só você vê isso. O jardim não é visitável. A Luna não cita o texto das suas cartas.</p></Section>
    <Section title="5. Serviços de terceiros"><p>Podemos usar provedores especializados para autenticação, hospedagem, armazenamento, análise técnica e pagamentos. Esses provedores recebem apenas os dados necessários para executar suas funções e devem aplicar suas próprias políticas de privacidade.</p></Section>
    <Section title="6. Retenção e segurança"><p>Adotamos controles técnicos e organizacionais compatíveis com o porte e a finalidade do serviço. Mantemos dados enquanto a conta estiver ativa ou enquanto forem necessários para cumprir obrigações legais, resolver disputas e prevenir abusos. Nenhum sistema conectado à internet é completamente invulnerável.</p></Section>
    <Section title="7. Seus direitos"><p>Você pode solicitar acesso, correção, exclusão, informação sobre o uso e portabilidade dos seus dados, observadas as limitações legais e técnicas. Para exercer esses direitos, escreva para <a href="mailto:contato.refugiodalua@gmail.com">contato.refugiodalua@gmail.com</a> ou use a página de contato no site.</p></Section>
    <Section title="8. Atualizações"><p>Podemos atualizar esta política quando o produto mudar. A data no topo indicará a versão vigente. Mudanças relevantes serão comunicadas por meios razoáveis dentro da plataforma.</p></Section>
...
export function TermsPage() {
  return <InfoShell eyebrow="convivência com cuidado" title="Termos de Uso" intro="Estes termos definem as regras básicas para usar o Refúgio com segurança, respeito e expectativas claras.">
    ...
    <Section title="5. Limites de cuidado"><p>O Refúgio oferece apoio digital e não substitui profissionais de saúde, terapia, atendimento médico ou serviços de emergência. Não use o site como único recurso em uma crise. Em risco imediato, procure ajuda local ou ligue para o serviço de emergência adequado. No Brasil, o CVV atende pelo 188.</p></Section>
    ...
    <Section title="9. Atualizações e contato"><p>Estes termos podem ser atualizados quando o produto ou as exigências legais mudarem. A versão vigente será indicada pela data no topo da página. Em caso de dúvida, escreva para <a href="mailto:contato.refugiodalua@gmail.com">contato.refugiodalua@gmail.com</a>.</p></Section>
