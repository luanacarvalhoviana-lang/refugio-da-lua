...
export function AboutPage() {
  return <InfoShell eyebrow="um lugar para pousar" title="Cuidado sem pressa, presença sem julgamento." intro="O Refúgio da Lua é um espaço digital de acolhimento, escrita e autocuidado para quem precisa de um lugar seguro para chegar como está.">
    ...
    <Section title="Quem está por trás"><p>O Refúgio da Lua é um projeto independente criado por Luana Viana, a partir de uma ideia simples: um espaço digital onde as pessoas possam escrever, desabafar e expressar o que sentem com mais liberdade, respeito e acolhimento.</p><p>O projeto nasceu da percepção de que, muitas vezes, precisamos colocar os pensamentos para fora, mas nem sempre encontramos um lugar onde nos sentimos à vontade para falar.</p><p>Por isso o Refúgio busca um ambiente reservado, em que cada pessoa se expressa no próprio tempo, sem precisar se expor além do que deseja.</p><p>Seu lugar de paz em meio ao caos.</p></Section>
    <Section title="A criadora"><p><strong>Luana Viana</strong></p><p>Fundadora e criadora do Refúgio da Lua. Responsável pela concepção do projeto e pelo desenvolvimento da plataforma, Luana criou o Refúgio para unir tecnologia, privacidade e acolhimento numa experiência digital simples e acessível.</p></Section>
